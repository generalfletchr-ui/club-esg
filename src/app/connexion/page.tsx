            ...
            <div className="flex flex-col gap-1">
              ...
              <div className="relative">
                <input
                  ...
                  className="h-[34px] w-full rounded-[6px] border border-[#e5e7eb] bg-white px-[10px] pr-8 text-[12px] text-[#111827] placeholder:text-[#9ca3af] outline-none transition-colors focus:border-[#016050]"
                />
                <button
                  type="button"
                  tabIndex={-1}
